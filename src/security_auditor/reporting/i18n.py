...
MESSAGES = {
    ...
    "osv_advisory_warning": "OSV 回傳的漏洞公告參照數量超過本次掃描的安全處理上限；已保留上限內可確認的結果，其餘項目尚未完成分析。",
    "osv_advisories_seen": "公告參照數",
    "osv_advisories_accepted": "納入處理數",
    "osv_advisories_truncated": "尚未分析數",
    "scope": "掃描範圍與排除項目",
...
DIAGNOSTICS = {
    ...
    "DEPENDENCY_OSV_ADVISORY_LIMIT_REACHED": "OSV 漏洞公告參照已達安全處理上限，其餘項目尚未完成分析。",
