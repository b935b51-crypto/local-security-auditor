...
def report_view(report: ScanReport) -> dict:
    ...
    return {
        ...
        "discovery": {"admitted_files": report.discovery.summary.stats.files_admitted,
                      ...
                      "scope": {
                          "default_exclusions_applied": bool(report.discovery.summary.stats.default_exclusions),
                          "excluded_directories": report.discovery.summary.stats.directories_excluded,
                          "excluded_files": report.discovery.summary.stats.files_excluded,
                          "excluded_by_default_policy": report.discovery.summary.stats.default_exclusions,
                          "excluded_by_user_policy": report.discovery.summary.stats.user_exclusions,
                          "entries_omitted": report.discovery.exclusions_omitted,
                          "entries": [{"path": safe_path(x.path), "class": x.scope_class.value,
                                       "reason": x.reason.value, "is_directory": x.is_directory}
                                      for x in report.discovery.exclusions],
                      }},
        ...
        "summary": {"counts": {"total_findings": report.counts.total_findings,
                    ...
                    "dependency": {"packages": report.dependency.packages,
                                   ...
                                   "provider": report.dependency.provider,
                                   "assessed_exact_versions": report.dependency.assessed_exact_versions,
                                   "unassessed_exact_versions": report.dependency.unassessed_exact_versions,
                                   "fresh_cache_hits": report.dependency.fresh_cache_hits,
                                   "stale_cache_hits": report.dependency.stale_cache_hits,
                                   "oldest_cache_age_seconds": report.dependency.oldest_cache_age_seconds,
                                   "newest_cache_age_seconds": report.dependency.newest_cache_age_seconds,
                                   "cache_ttl_seconds": report.dependency.cache_ttl_seconds,
                                   ...
                                   "batch_requests_used": report.dependency.batch_requests_used,
                                   "batch_requests_limit": report.dependency.batch_requests_limit,
                                   "detail_requests_used": report.dependency.detail_requests_used,
                                   "detail_requests_limit": report.dependency.detail_requests_limit,
                                   "total_requests_used": report.dependency.total_requests_used,
                                   "total_requests_limit": report.dependency.total_requests_limit,
                                   "deduplicated_advisories": report.dependency.deduplicated_advisories,
                                   "provider_budget_reached": report.dependency.provider_budget_reached,
                                   "advisories_seen": report.dependency.advisories_seen,
                                   "advisories_accepted": report.dependency.advisories_accepted,
                                   "advisories_truncated": report.dependency.advisories_truncated,
                                   "advisory_limit": report.dependency.advisory_limit,
                                   "advisory_limit_reached": report.dependency.advisory_limit_reached},
