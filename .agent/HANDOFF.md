...
- Python 3.14.7 unittest: 36 tests, 35 passed, 1 skipped because real Windows symlink creation is unavailable. Package/config/AST, docs links, and project Skill frontmatter checks passed.
